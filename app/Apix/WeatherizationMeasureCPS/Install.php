...
return new class extends Installer
{
    ...
    public function migrations(): array
    {
        return [
            ...
            'apix_weatherization_products_cps_work_orders' => app_path('Apix/WeatherizationMeasureCps/migrations/create_apix_weatherization_products_cps_work_orders_table.php'),
        ];
    }
};
