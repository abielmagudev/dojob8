...
use App\Xapis\Stock\WeatherizationProductCps\Exports\WeatherizationProductCpsWorkOrderExport;
...
class ExportController extends Controller
{
    public function index(Extension $extension)
    {
        return view('WeatherizationProductCps/views/exports/index', [
            ...
            'work_orders' => XapiWorkOrder::with('work_order')->get(),
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $query = XapiWorkOrder::with(['product', 'work_order']);
        ...
        return Excel::download(
            new WeatherizationProductCpsWorkOrderExport([
                'measures' => $measures,
