...
class CategoryController extends Controller
{
    ...
    public function store(CategorySaveRequest $request, Extension $extension)
    {
        ...
        return redirect()->route('extensions.show', [$extension, 'concept' => 'category'])->with('success', "Category <b>{$category->name}</b> saved");
    }
    ...
    public function update(CategorySaveRequest $request, Extension $extension)
    {
        ...
        return redirect()->route('extensions.edit', [$extension, 'concept' => 'category', 'category' => $category->id])->with('success', "Category <b>{$category->name}</b> updated");
    }
