...
<x-form-control-horizontal class="align-items-center">
    ...
    <x-custom.data-city-name-input :old="old('city_name', $contractor->city_name)" required />
...
<x-form-control-horizontal class="align-items-center">
    ...
    <x-custom.data-state-code-select :country="old('country_code', $contractor->country_code)" :old="old('state_code', $contractor->state_code)" required />
...
<x-form-control-horizontal class="align-items-center">
    ...
    <x-custom.data-country-code-select :old="old('country_code', $contractor->country_code)" required />
