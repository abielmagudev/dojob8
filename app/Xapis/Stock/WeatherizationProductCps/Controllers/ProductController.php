...
use App\Xapis\Stock\WeatherizationProductCps\Requests\ProductSaveRequest;
...
class ProductController extends Controller
{
    ...
    {
        return view('WeatherizationProductCps/views/products/index', [
            'extension' => $extension,
    ...
    {
        return view('WeatherizationProductCps/views/products/create', [
            'extension' => $extension,
    ...
    public function edit(Request $request, Extension $extension)
    {
        ...
        return view('WeatherizationProductCps/views/products/edit', [
            'extension' => $extension,
            'categories' => Category::all(),
            'product' => $product,
        ]);
