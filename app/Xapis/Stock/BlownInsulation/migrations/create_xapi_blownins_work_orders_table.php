...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('xapi_blownins_work_orders', function (Blueprint $table) {
            ...
            $table->foreignId('work_order_id')->references('id')->on('work_orders')->onDelete('cascade')->index('xapi_blownins_work_order_foreign');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('xapi_blownins_work_orders');
    }
};
