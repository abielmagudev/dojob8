...
<x-card title="New category">
    <form action="{{ route('extensions.store', [$extension, 'concept' => 'category']) }}" method="post" autocomplete="off">
        ...
        <div class="text-end">
            ...
            <a href="{{ route('extensions.show', [$extension, 'concept' => 'category']) }}" class="btn btn-primary">Cancel</a>
        </div>
    </form>
</x-card>
@endsection
