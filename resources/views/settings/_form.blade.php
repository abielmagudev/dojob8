<h6 class="text-secondary mb-3">Administrator</h6>
<div class="mb-3">
    <label for="companyNameInput" class="form-label">Company</label>
    <input id="companyNameInput" type="text" class="form-control {{ bsInputInvalid( $errors->has('company_name') ) }}" name="company_name" value="{{ old('company_name', $settings->get('company_name')) }}" autofocus required>
...
<div class="mb-3">
    ...
    <x-custom.select-state-code-data country="{{ $settings->get('country_code') }}" required>{{ old('state_code') }}</x-custom.select-state-code-data>
