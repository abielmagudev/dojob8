...
use App\Xapis\Stock\WeatherizationProductCps\Requests\CategorySaveRequest;
...
class CategoryController extends Controller
{
    ...
    {
        return view('WeatherizationProductCps/views/categories/index', [
            'extension' => $extension,
    ...
    {
        return view('WeatherizationProductCps/views/categories/create', [
            'extension' => $extension,
    ...
    public function edit(Request $request, Extension $extension)
    {
        ...
        return view('WeatherizationProductCps/views/categories/edit', [
            'extension' => $extension,
            'category' => $category,
        ]);
    }
