...
class WorkOrderFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'working_at' => WorkOrder::inIncompleteStatuses($status) ? $this->faker->dateTimeBetween('-3 years') : null,
            'done_at' => WorkOrder::inIncompleteStatuses($status) ? $this->faker->dateTimeBetween('-3 years') : null,
            'completed_at' => WorkOrder::inIncompleteStatuses($status) ? $this->faker->dateTimeBetween('-3 years') : null,
            'closed_at' => WorkOrder::inIncompleteStatuses($status) ? $this->faker->dateTimeBetween('-3 years') : null,
